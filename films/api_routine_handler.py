...
from films_db_models import Producer, Actor


def creation_routine_handler(lst, cls, session, db_obj):
    """
       ...
       - db_obj: The film object with which the entities will be associated.
